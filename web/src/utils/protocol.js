...
export var Protocol = {
   ...
   *
   * @param  {Number}    type   封装类型
   * @param  {ByteArray} body   正文内容（字节）
   * @return {ByteArray}        包含编码结果的新字节数组
   */
   ...
   * 请参阅编码以了解包格式。
   *
   * @param  {ByteArray} buffer 包含包内容的字节数组
   * @return {Object}           {type：包类型，buffer：body字节数组}
   */
