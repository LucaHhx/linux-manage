...
export function generateData(count) {
  ...
  const names = ['JamessSSSSSssssssssssssJamessSSSSSssssssssssssJamessSSSSSssssssssssssJamessSSSSSssssssssssssJamessSSSSSssssssssssssJamessSSSSSssssssssssssJamessSSSSSssssssssssss', 'John', 'Robert', 'Christopher', 'George', 'Mary', 'Nancy', 'Sandra', 'Michelle', 'Betty']
